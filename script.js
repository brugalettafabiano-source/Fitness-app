...
const defaultDiet = {
  Lun:{
    Colazione:[{id:1,name:'Latte scremato 250ml',kcal:115,p:8.5,c:12.5,f:4},{id:2,name:'Banana',kcal:90,p:1,c:23,f:0.3},{id:3,name:'Avena 60g',kcal:222,p:8,c:36,f:4.2}],
    Pranzo:[{id:1,name:'Pasta al pomodoro 120g',kcal:490,p:15.2,c:93,f:6.7},{id:2,name:'Petto di pollo 180g',kcal:200,p:41.5,c:0,f:1.6},{id:3,name:'Insalata condita 50g',kcal:34,p:0.3,c:1,f:3.1}],
    Spuntino:[{id:1,name:'Yogurt 0 150g',kcal:81,p:14.7,c:5.7,f:0}],
